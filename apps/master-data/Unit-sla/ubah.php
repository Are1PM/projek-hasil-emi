<div class="row">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <textarea name="alamat" class="form-control" rows="2" class="textarea" required placeholder="Alamat">
               <?= $data->alamat; ?>
            </textarea>
            </div>
        </div>
        ...
        <?php
            if (isset($_POST['simpan'])) {
                ...
                $proses = new MengelolaUnitsla($Id_SLA,$nama,$username,$password,$no_hp,$alamat);
