...
class Pengajuanservis
{
    ...
    public function queryKonfirmasi()
    {
        ...
        $sql = "UPDATE pengajuan_servis SET id_status='$id_status',keterangan='$keterangan' where id_pengajuan_servis='$id_pengajuan_servis'";
        $prepare = $this->konek->execute()->prepare($sql);
        $proses = $prepare->execute();
        $keterangan = $this->getKeterangan();
    }
    ...
    public function queryFilterPengajuanservis($id_status)
    {
        ...
        if ($_SESSION['hak_akses'] == "unit_sla") {
            ...
            $sql = "SELECT * FROM pengajuan_servis inner join driver, tempat_servis, kendaraan where  tempat_servis.id_tempat_servis=pengajuan_servis.id_tempat_servis AND kendaraan.id_kendaraan=pengajuan_servis.id_kendaraan AND driver.id_driver=pengajuan_servis.id_driver AND pengajuan_servis.id_status='$id_status'";
        }
