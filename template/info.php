...
<div class="row d-flex justify-content-around m-2">
  <div class="card col-md-3">
    ...
    <div class="card-body col-12">
      ...
      <a href="?emi=detail-info&target=ldp&status=1">
      ...
      <a href="?emi=detail-info&target=ldp&status=2">
  ...
  <div class="card col-md-3">
    ...
    <div class="card-body">
      ...
      <a href="?emi=detail-info&target=bbm&status=1">
        <div class='badge badge-success d-flex justify-content-between mb-2'>
          <span class="h5"><b>Disetujui</b></span>
      ...
      <a href="?emi=detail-info&target=bbm&status=2">
        <div class='badge badge-danger d-flex justify-content-between'>
          <span class="h5"><b>Ditolak</b></span>
  ...
  <div class="card col-md-3">
    ...
    <div class="card-body">
      ...
      <a href="?emi=detail-info&target=service&status=1">
        <div class='badge badge-success d-flex justify-content-between mb-2'>
          <span class="h5"><b>Disetujui</b></span>
      ...
      <a href="?emi=detail-info&target=service&status=2">
        <div class='badge badge-danger d-flex justify-content-between'>
          <span class="h5"><b>Ditolak</b></span>
